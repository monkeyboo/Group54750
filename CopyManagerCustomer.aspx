...
<script runat="server">
    Protected Sub Page_Load(sender As Object, e As EventArgs)
        ...
        If Session("name") IsNot DBNull.Value Then
            ComboBox1 = Session("name")
        End If
    End Sub
                        ...
                        <asp:DetailsView ID="CustDetails" runat="server" AutoGenerateRows="False" CellPadding="4" DataKeyNames="CustID" DataSourceID="SqlDataSource2" Height="50px" Width="800px" ForeColor="Black" GridLines="None">
                            ...
                            <Fields>
                                ...
                                <asp:TemplateField ShowHeader="False">
                                    <EditItemTemplate>
                                        <asp:Button ID="Button1" runat="server" CausesValidation="True" ValidatonGroup="VG1" CommandName="Update" Text="Update" BackColor="#E6D9CC" Width="75px" OnClick="Update_Click"/>
